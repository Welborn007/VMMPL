...
public class Iron_Pellets extends Fragment {
    ...
    public static Iron_Pellets newInstance(int i, String s) {
        Iron_Pellets fragmentsixth = new Iron_Pellets();
    ...
    {
        view = inflater.inflate(R.layout.fragment_iron__pellets, container, false);
        ...
        a1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("product","Iron Ore Pellets");
