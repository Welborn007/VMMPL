...
public class Fluoridated_Salt extends Fragment {
    ...
    public static Fluoridated_Salt newInstance(int i, String s) {
        Fluoridated_Salt fragmentthird= new Fluoridated_Salt();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        view = inflater.inflate(R.layout.fragment_fluoridated__salt, container, false);
        ...
        a1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("product","Flouridated Salt");
