...
public class Snowphyll extends Fragment {
    ...
    public static Snowphyll newInstance(int i, String s) {
        Snowphyll fragmentthird= new Snowphyll();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        view = inflater.inflate(R.layout.fragment_snowphyll, container, false);
        ...
        a1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("product","Phytoscience Snowphyll");
