...
public class Hide_salt extends Fragment {
    ...
    public static Hide_salt newInstance(int i, String s) {
        Hide_salt fragmentsecond= new Hide_salt();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        view = inflater.inflate(R.layout.fragment_hide_salt, container, false);
        ...
        a1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("product","Hide Salt");
